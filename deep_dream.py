...
RESULTS_FOLDER_DEEPDREAM = os.path.join("results", "deepdream")
if not os.path.exists(RESULTS_FOLDER_DEEPDREAM):
    os.makedirs(RESULTS_FOLDER_DEEPDREAM)
    ...
    def dream(self):
        ...
        for i in range(1, 251):
            ...
            if i % 10 == 0:
                ...
                im_path = RESULTS_FOLDER_DEEPDREAM + '/ddream_' + str(self.selected_layer) + \
